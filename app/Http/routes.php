...
Route::patch('doencas/lista/{doenca}/update', 'DoencasController@atualizar');
...
Route::patch('ciclos/lista/{ciclo}/update', 'CiclosController@atualizar');
...
Route::patch('tolerancias/lista/{tolerancia}/update', 'ToleranciasController@atualizar');
...
Route::patch('epocas_semeadura/lista/{epoca_semeadura}/update', 'EpocasSemeaduraController@atualizar');
